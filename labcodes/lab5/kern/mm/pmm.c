...
get_pte(pde_t *pgdir, uintptr_t la, bool create) {
     ...
     *   PTX(la) = the index of page entry of VIRTUAL ADDRESS la.
	 *   PDE_ADDR(pde_t) : get address in directory entry
	 *   PTE_ADDR(pte_t) : get address in page entry
